...
class Gui455:
    ...
    def quit_window2(self, val):
        ...
        self.myCan.itemconfig(self.stringName[currPlace], text= str(currPlace) + ". > " + wordType + ", Value = " + str(self.valCount) + ", Time Allowed = " + str(self.timeChoice))
    ...
    def execute_threads(self, val):
        ...
        self.curStr = self.myCan.create_text(self.pos_x, self.pos_y, fill="green", anchor="center", text="Stage = " + str(self.runCount))
        self.isRunning = True
    ...
    def animation_thread(self):
        ...
        while(self.isRunning):
            ...
            for i in range(1, 7):
                ...
                self.curStr = self.myCan.create_text(self.pos_x, self.pos_y, fill=color_value, anchor="center", text="Stage = " + str(self.runCount))
    ...
    def button_pressed(self, val):
        ...
        if (val == 6):
            if (len(self.command_list) > 0 and self.isRunning == False):
                ...
                self.myCan.itemconfig(self.stringName[len(self.command_list) + 1], text=str(len(self.command_list) + 1) + ".")
                self.step -= 20
